...
export default function TagForm({
  ...
  const createTagMutation = clientApi.tag.create.useMutation()
  const updateTagMutation = clientApi.tag.update.useMutation()
  ...
  const onTagSubmit = async (data: TagFormData) => {
    const mutationFunction = async () => {
      if (initialFormData) {
        return await updateTagMutation.mutateAsync({
          ...data,
