...
declare module "nextjs-routes" {
  ...
  export type Route =
    ...
    | StaticRoute<"/">
    | StaticRoute<"/users">
    | DynamicRoute<"/password-reset/[token]", { "token": string }>
    | StaticRoute<"/privacy-policy">
    | StaticRoute<"/api/cron/check-announcements">
    | StaticRoute<"/api/cron/delete-old-orders">
    | StaticRoute<"/api/cron/send-order-summary">;
